...
function Routes() {
  return (
    <Switch>
      ...
      <Route exact path="/superheroes/:id" component={SuperheroShow} />
      <Route exact path="/superheroes/:id/edit" component={SuperheroEdit} />
      <Route exact path="/superheroes/:id/destroy" component={SuperheroDestroy} />
    </Switch>
  );
}
